...
inline const exec_handle exec[64] = {
    ...
    [](u32 i) // lwl 0x22
    {
        reg[RT(i)] = (reg[RT(i)] & 0xFFU) |
                     (static_cast<u32>(hw_at(reg[RS(i)] + static_cast<i16>(IMM(i)) + 2)) << 16U);
    },
    [](u32 i) // lw 0x23
    ...
    {
        reg[RT(i)] =
            (reg[RT(i)] & 0xFF00U) | static_cast<u32>(hw_at(reg[RS(i)] + static_cast<i16>(IMM(i))));
    },
    trap,     // 0x27
    [](u32 i) // sb 0x28
